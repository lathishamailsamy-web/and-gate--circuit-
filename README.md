...
## WORKING
The 9V battery supplies DC power to the circuit. Because the switches are wired in a series layout, electricity is blocked if either button is open. When both buttons are pressed together, the circuit path closes, allowing current to flow through the resistor and illuminate the blue LED.
